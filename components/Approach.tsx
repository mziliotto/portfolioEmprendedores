    ...
    <section  className="w-full py-20">
      ...
      <div className="py-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
           ...
           description="Nos centraremos en las metas del sitio web, audiencia deseada y funcionalidades. 
           Discutiremos estructura, navegación y contenido."
           >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card 
           ...
           description="Convierto lo charlado en ideas/formas de traducirlo a código. Te mantendré actualizado sobre el estado del proyecto en cada paso del plan."
           >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card 
           ...
           description="Construcción del sitio."
           >
          <CanvasRevealEffect
            animationSpeed={3}
